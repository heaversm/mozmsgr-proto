...
<template>
    <aside class="flex flex-col items-center md:items-stretch space-y-2 md:space-y-4">
        <router-link :to="{ name: 'Home' }" class="inline-block rounded-full hover:bg-gray-100 p-3 md:self-start">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 md:h-10 w-8 md:w-10 text-violet-500" viewBox="0 0 20 20" fill="currentColor">
                <path class="st0" d="M14.7,6c1.9,0,3.6,1.1,3.6,3.7l0,0v4.8h1.4v2.3h-4.4v-5.9c0-1.8-0.6-2.5-1.9-2.5c-1.4,0-2,1-2,2.5v3.7h1.4v2.3
	H8.4v-5.9c0-1.8-0.6-2.5-1.8-2.5c-1.4,0-2,1-2,2.5v3.7h2v2.3H0.1v-2.3h1.4v-6H0.1V6.2h4.4v1.6C5.2,6.7,6.3,6,7.8,6
	c1.5,0,3,0.7,3.4,2.3C11.8,6.9,13,6,14.7,6z"/>
<path class="st1" style="fill: white;" d="M13.8,1.9C13.6,2,13.4,2,13.3,2.1c-0.2,0.1-0.3,0.3-0.4,0.5c-0.1,0.2-0.1,0.2-0.1,1.6c0,1.3,0,1.3,0,1.4
	C12.9,5.8,13,6,13.1,6.1c0.2,0.2,0.5,0.3,0.7,0.3c0,0,0.4,0,0.8,0l0.7,0v0.8v0.8l1-0.8l1-0.8l0.8,0c0.7,0,0.8,0,0.9,0
	c0.5-0.1,0.8-0.4,0.9-0.9c0-0.1,0-0.3,0-1.4c0-1.3,0-1.3,0-1.4c-0.2-0.4-0.5-0.7-0.9-0.8c-0.1,0-0.3,0-2.6,0
	C15,1.9,13.9,1.9,13.8,1.9z"/>
<path d="M14.1,1.2c-0.3,0.1-0.4,0.1-0.6,0.2c-0.2,0.1-0.3,0.3-0.4,0.5C13,2.1,13,2.1,13,3.5c0,1.3,0,1.3,0,1.4
	c0.1,0.2,0.2,0.3,0.3,0.5c0.2,0.2,0.5,0.3,0.7,0.3c0,0,0.4,0,0.8,0l0.7,0v0.8v0.8l1-0.8l1-0.8l0.8,0c0.7,0,0.8,0,0.9,0
	c0.5-0.1,0.8-0.4,0.9-0.9c0-0.1,0-0.3,0-1.4c0-1.3,0-1.3,0-1.4c-0.2-0.4-0.5-0.7-0.9-0.8c-0.1,0-0.3,0-2.6,0
	C15.3,1.2,14.2,1.2,14.1,1.2z"/>
            </svg>
        </router-link>
